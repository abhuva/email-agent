...
- **[V4 CLI Usage](v4-cli-usage.md)** — Complete command-line interface reference and usage guide ✅
...
- **[V4 Installation & Setup](v4-installation-setup.md)** — Installation, setup, and initial configuration guide ✅
- **[V4 Quick Start](v4-quick-start.md)** — Minimal setup guide to get V4 running quickly ✅
- **[V4 Configuration Reference](v4-configuration-reference.md)** — Complete configuration reference with all options and examples ✅
- **[V4 Rule Syntax Guide](v4-rule-syntax-guide.md)** — Complete rule syntax reference for blacklist and whitelist rules ✅
- **[V4 Migration Guide](v4-migration-guide.md)** — Step-by-step guide for migrating from V3 to V4 ✅
- **[V4 Multi-Account Best Practices](v4-multi-account-best-practices.md)** — Best practices for multi-account deployments ✅
- **[V4 Troubleshooting](v4-troubleshooting.md)** — Comprehensive troubleshooting guide for common V4 issues ✅
...
- **[CI Integration](ci-integration.md)** — CI/CD configuration and test automation ✅

## Historical V3 Module Documentation

### Core V3 Features (Historical - Superseded by V4)
- **[V3 Configuration Guide](v3-configuration.md)** — V3 configuration system, schema, and settings facade (Historical) ✅
- **[V3 Migration Guide](v3-migration-guide.md)** — Migrating from V2 to V3 configuration patterns (Historical) ✅
- **[V3 CLI](v3-cli.md)** — V3 command-line interface (Historical - superseded by V4 CLI) ✅
- **[V3 IMAP Client](v3-imap-client.md)** — IMAP connection and email retrieval (Historical) ✅
- **[V3 LLM Client](v3-llm-client.md)** — LLM API interactions with retry logic (Historical) ✅
- **[V3 Decision Logic](v3-decision-logic.md)** — Threshold-based classification system (Historical) ✅
- **[V3 Note Generator](v3-note-generator.md)** — Jinja2 templating system for Markdown note generation (Historical) ✅
- **[V3 Logging Integration](v3-logging-integration.md)** — Dual logging system (operational logs + structured analytics) (Historical) ✅
- **[V3 Orchestrator](v3-orchestrator.md)** — High-level pipeline orchestration coordinating all components (Historical) ✅

### V3 Advanced Features (Historical)
- **[V3 Force-Reprocess](v3-force-reprocess.md)** — Force-reprocess capability for reprocessing already-processed emails (Historical) ✅
- **[V3 Cleanup Flags](v3-cleanup-flags.md)** — Safeguarded command to remove application-specific IMAP flags (Historical) ✅
- **[V3 Backfill](v3-backfill.md)** — Process historical emails with date range filtering, progress tracking, and throttling (Historical) ✅
- **[V3 Dry-Run Mode](v3-dry-run.md)** — Preview processing without making changes (Historical) ✅

### V3 Testing & CI/CD (Historical)
- **[V3 E2E Tests](v3-e2e-tests.md)** — End-to-end tests with live IMAP connections (Historical) ✅
- **[Test Isolation Fix](test-isolation-fix.md)** — Settings singleton reset fixture for test isolation (Historical) ✅
